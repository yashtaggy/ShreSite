...
import { 
  ...
  MapPin, Settings, Microscope, Globe, Target, Eye
} from 'lucide-react';
            ...
            <div className="lg:col-span-8">
              ...
              <div className="prose prose-slate space-y-6 text-slate-600 leading-relaxed">
                <p>
                  ...
                  <span className="text-slate-900 font-semibold"> Wire-wound and Conductive Plastic sensing elements.</span>
                </p>
                <p>
                  Our facility in Pune serves as a hub of indigenous innovation. We don't 
                  just assemble sensors; we engineer them from the wire up. This level of 
                  control allows us to offer tolerances as tight as <strong>±0.05%</strong>, 
                  meeting the rigorous standards of defense and aerospace research.
                </p>
                <p>
                  Over the last decade, we have scaled our capabilities from a specialized 
                  ...
                  discipline of our proprietary 2150-step Process Flow Architecture.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="p-12 bg-white border border-slate-200 relative group overflow-hidden">
               <div className="absolute -right-8 -bottom-8 opacity-[0.05] group-hover:scale-110 transition-transform duration-700 text-slate-900">
                  <Target size={200} />
               </div>
