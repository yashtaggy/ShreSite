        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-20">
          {advantages.map((adv, i) => (
            <motion.div
              key={i}
              whileHover={{ y: -8 }}
              className="group relative p-10 bg-white border border-slate-200 rounded-sm flex flex-col justify-between transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.05)] hover:border-slate-300"
            >
