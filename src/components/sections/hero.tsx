...
export function Hero() {
  return (
    <section className="relative w-full bg-white">
      <div className="mx-auto max-w-7xl px-6 pt-28 pb-16 sm:pt-36 sm:pb-24 md:pt-48 md:pb-32">

        {/* POSITIONING BADGE */}
        <div className="inline-flex items-center rounded-full border bg-white px-4 py-1 text-xs sm:text-sm text-muted-foreground shadow-sm">
        ...
        {/* TRUST STRIP */}
        <div className="mt-8 sm:mt-16 flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-6 text-xs sm:text-sm text-muted-foreground border-t pt-4 sm:pt-6">
